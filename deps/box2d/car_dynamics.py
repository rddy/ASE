...
FRICTION_LIMIT          = 200*1000000*SIZE*SIZE     # friction ~= mass ~= size^2 (calculated implicitly using density)
WHEEL_R  = 27
WHEEL_W  = 14
WHEELPOS = [
    (-55,+80), (+55,+80),
...
class Car:
    ...
    def step(self, dt):
        for w in self.wheels:
            ...
            grass = True
            friction_limit = FRICTION_LIMIT#DEBUG*0.6  # Grass friction if no tile
            for tile in w.tiles:
